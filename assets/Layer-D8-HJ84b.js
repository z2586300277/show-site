...
`)n=0,t-=i;else{const u=be(o,l,n,t,r);n+=u.offsetX,a.push(u.path)}}return a}function be(T,e,r,s,l){const i=l.glyphs[T]||l.glyphs["?"];if(!i){console.error('THREE.Font: character "'+T+'" does not exists in font family '+l.familyName+".");return}const a=new j;let n,t,f,o,u,g,b,C;if(i.o){const h=i._cachedOutline||(i._cachedOutline=i.o.split(" "));for(let d=0,k=h.length;d<k;)switch(h[d++]){case"m":n=h[d++]*e+r,t=h[d++]*e+s,a.moveTo(n,t);break;case"l":n=h[d++]*e+r,t=h[d++]*e+s,a.lineTo(n,t);break;case"q":f=h[d++]*e+r,o=h[d++]*e+s,u=h[d++]*e+r,g=h[d++]*e+s,a.quadraticCurveTo(u,g,f,o);break;case"b":f=h[d++]*e+r,o=h[d++]*e+s,u=h[d++]*e+r,g=h[d++]*e+s,b=h[d++]*e+r,C=h[d++]*e+s,a.bezierCurveTo(u,g,b,C,f,o);break}}return{offsetX:i.ha*e,path:a}}const xe={name:"LuminosityHighPassShader",shaderID:"luminosityHighPass",uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new R(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}y.BlurDirectionX=new x(1,0);y.BlurDirectionY=new x(0,1);const Te={class:"btn"},Ce=ne({__name:"Layer",setup(T){const e=V();V(!0);const r=V(0);let s,l,i;ue(()=>{let n=a(e.value);s=n.camera,l=n.box,i=n.light});function a(n){const t=new J,f=new Z(50,n.clientWidth/n.clientHeight,.1,1e5);f.position.set(0,0,10),t.add(f);const o=new $({antialias:!0,alpha:!0,logarithmicDepthBuffer:!0});o.setSize(n.clientWidth,n.clientHeight),o.setPixelRatio(window.devicePixelRatio*2),o.setClearColor(0),n.appendChild(o.domElement),o.autoClear=!1,te(f,o);const u=new X(5500);t.add(u);const g=new Y(16777215,1);t.add(g);const b=new S(new F(1,1,1),new B({color:"yellow"}));t.add(b);const C=new S(new F(1,1,1),new B({color:"Cyan"}));C.position.set(0,2,0),C.layers.set(1),t.add(C);const h=new S(new F(1,1,1),new B({color:"blue"}));h.position.set(2,0,0),h.layers.set(2),t.add(h);const d=new S(new F(1,1,1),new B({color:"red"}));d.position.set(0,0,2),d.layers.set(3),t.add(d);const k=new ve;let w;k.load("/font.json",function(W){const N=new ce("Layers",{font:W,size:1,height:.2,curveSegments:12,bevelEnabled:!0,bevelThickness:0,bevelSize:0,bevelSegments:5});w=new S(N,new B({color:"pink"})),w.position.set(0,-2,0),t.add(w)});const Q=new re(t,f);var A=new y(new x(window.innerWidth,window.innerHeight),1.5,0,0);A.renderToScreen=!0,new ee().set(1),new le;const z=new ae(o);z.addPass(Q),z.addPass(A),E();function E(){console.log(w),z.render(),e.value&&requestAnimationFrame(E)}return{camera:f,box:b,light:g}}return(n,t)=>{const f=_("el-input"),o=_("el-button");return me(),he(de,null,[U("div",Te,[m(f,{modelValue:r.value,"onUpdate:modelValue":t[0]||(t[0]=u=>r.value=u)},null,8,["modelValue"]),U("div",null,[m(o,{onClick:t[1]||(t[1]=()=>v(s).layers.enable(r.value))},{default:c(()=>[p("camera 增加与此图层联系")]),_:1}),m(o,{onClick:t[2]||(t[2]=()=>v(s).layers.disable(r.value))},{default:c(()=>[p(" camera 取消与此图层联系")]),_:1}),m(o,{onClick:t[3]||(t[3]=()=>v(s).layers.toggle(r.value))},{default:c(()=>[p("camera 切换与此图层的联系 有/无")]),_:1}),m(o,{onClick:t[4]||(t[4]=()=>v(s).layers.set(r.value))},{default:c(()=>[p(" camera 只与此图层联系")]),_:1}),m(o,{onClick:t[5]||(t[5]=()=>v(s).layers.enableAll())},{default:c(()=>[p(" camera 与所有图层联系")]),_:1}),m(o,{onClick:t[6]||(t[6]=()=>v(s).layers.disableAll())},{default:c(()=>[p(" camera 取消所有图层联系")]),_:1})]),U("div",null,[m(o,{onClick:t[7]||(t[7]=()=>v(l).layers.enable(r.value))},{default:c(()=>[p("box 增加与此图层联系")]),_:1}),m(o,{onClick:t[8]||(t[8]=()=>v(l).layers.disable(r.value))},{default:c(()=>[p(" box 取消与此图层联系")]),_:1}),m(o,{onClick:t[9]||(t[9]=()=>v(l).layers.toggle(r.value))},{default:c(()=>[p("box 切换与此图层的联系 有/无")]),_:1}),m(o,{onClick:t[10]||(t[10]=()=>v(l).layers.set(r.value))},{default:c(()=>[p(" box 只与此图层联系")]),_:1}),m(o,{onClick:t[11]||(t[11]=()=>v(l).layers.enableAll())},{default:c(()=>[p(" box 与所有图层联系")]),_:1}),m(o,{onClick:t[12]||(t[12]=()=>v(l).layers.disableAll())},{default:c(()=>[p(" box 取消所有图层联系")]),_:1})]),U("div",null,[m(o,{onClick:t[13]||(t[13]=()=>v(i).layers.enable(r.value))},{default:c(()=>[p("light 增加与此图层联系")]),_:1}),m(o,{onClick:t[14]||(t[14]=()=>v(i).layers.disable(r.value))},{default:c(()=>[p(" light 取消与此图层联系")]),_:1}),m(o,{onClick:t[15]||(t[15]=()=>v(i).layers.toggle(r.value))},{default:c(()=>[p("light 切换与此图层的联系 有/无")]),_:1}),m(o,{onClick:t[16]||(t[16]=()=>v(i).layers.set(r.value))},{default:c(()=>[p(" light 只与此图层联系")]),_:1}),m(o,{onClick:t[17]||(t[17]=()=>v(i).layers.enableAll())},{default:c(()=>[p(" light 与所有图层联系")]),_:1}),m(o,{onClick:t[18]||(t[18]=()=>v(i).layers.disableAll())},{default:c(()=>[p(" light 取消所有图层联系")]),_:1})])]),U("div",{class:"threeBox",ref_key:"threeBox",ref:e},null,512)],64)}}}),Ue=fe(Ce,[["__scopeId","data-v-a8040995"]]);export{Ue as default};
